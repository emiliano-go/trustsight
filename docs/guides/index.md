...
| [Using TrustSight in CI](using-in-ci.md) | You want to gate package installs in a CI/CD pipeline using policy thresholds on the JSON report. |
...
- [Code rules reference (C001-C010)](../reference/rules/system.md#c-series)
