...
- **[Rules](rules.md)**: R001-R131 (R-series, TOML-configurable and code-emitted) and C001-C007 (code, structural) with severity, weight, target, and description for each.
