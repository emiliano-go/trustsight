...
- **[Rules](rules/index.md)**: R001-R151 (R-series, TOML-configurable and code-emitted), S001-S008 (sabotage), X001-X023 (crossfire), C001-C009 (code, structural), D001-D004 (dependency), P001-P008 (declared practice) and W001-W006 (unverifiable) with severity, weight, target, and description for each. The P and W series are weight 0: they report and never score. Organised by [category](rules/index.md#categories), one page per category, with the engine's own mechanics in [the system reference](rules/system.md).
