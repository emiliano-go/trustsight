...
|------|-------------|-------------------|
| A (Structural) | R001-R059, R078, R091, R099, R104, R144, R152, H001-H097, S001-S008, X001-X025, C001-C012, D001-D004 | Direct pattern matching against PKGBUILD commands and structure |
...
See [C010: Binary Metadata File](integrity.md#c010).

### C011 {#c011}

See [C011: Prebuilt Binary From Non-Upstream Host](integrity.md#c011).

### C012 {#c012}

See [C012: Source Domain Resembles Declared Upstream](deception.md#c012).
