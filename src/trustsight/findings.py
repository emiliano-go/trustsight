...
TEMPLATES: dict[str, str] = {
    ...
    "R141": "{package} was orphaned in the AUR and now has a maintainer",
    "R142": "the build recipe changed while source URLs, checksums and pkgver did not",
    "R143": "{package} was adopted from orphan, its recipe changed with no upstream move, and {position}() now resolves dependencies from a registry: {body}",
