...
#: One request.  Larger than ``[diff] max_diff_bytes`` (5 MiB) because the
#: request is the diff plus a little framing, and the sandbox must be able
#: to carry the largest diff the analysis is configured to examine.
